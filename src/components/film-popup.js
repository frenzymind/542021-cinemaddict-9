...
export const getFilmPopup = (film) => {
    ...
    <div class="form-details__top-container">
      ...
      <div class="film-details__info-wrap">
        <div class="film-details__poster">
          <img class="film-details__poster-img" src="${film.imgSrc}" alt="">
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">30 March ${film.year}</td>
            </tr>
            <tr class="film-details__row">
              <td class="film-details__term">Runtime</td>
              <td class="film-details__cell">${film.durationHour}h ${
  film.durationMinute
}m</td>
            </tr>
            <tr class="film-details__row">
  ...
  film.watchList === true ? `checked` : ``
}>Add to watchlist</label>

        <input type="checkbox" class="film-details__control-input visually-hidden" id="watched" name="watched" ${
  film.watched === true ? `checked` : ``
}>
